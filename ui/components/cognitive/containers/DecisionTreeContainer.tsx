            ...
            <div className="flex flex-col gap-3">
                ...
                <div className="grid gap-4">
                    {content.conditions.map((item, idx) => (
                        <div key={idx} className="relative pl-6 border-l-2 border-dashed border-gray-700 hover:border-blue-500/50 transition-colors">
                            ...
                            <div className="flex flex-col gap-1">
                                ...
                                <div className="flex items-center gap-2 mt-2">
                                    ...
                                    <span className="text-[10px] px-1.5 py-0.5 rounded bg-white/10 text-gray-400">{item.source}</span>
                                </div>
                            </div>
                        </div>
                    ))}
            ...
            {content.frame_challenger && (
                <div className="bg-purple-500/10 border border-purple-500/30 rounded-xl p-4 mt-2">
                    <div className="flex items-center justify-between mb-2">
                        ...
                        <span className="text-[10px] bg-purple-500/20 text-purple-300 px-2 py-0.5 rounded-full">{content.frame_challenger.source}</span>
                    </div>
                    <p className="text-purple-100 mb-2">{content.frame_challenger.position}</p>
                    <p className="text-sm text-purple-300/80 italic">Consider if: {content.frame_challenger.consider_if}</p>
                </div>
            )}
        </div>
    );
