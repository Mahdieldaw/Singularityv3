        ...
        <div className="flex flex-col gap-6 p-4 text-white">
            ...
            <div className="grid gap-4 sm:grid-cols-2">
                {content.paradigms.map((paradigm, idx) => (
                    <div
                        key={idx}
                        className="flex flex-col bg-gradient-to-br from-white/5 to-white/[0.02] border border-white/10 rounded-xl p-4 hover:border-white/20 transition-all group"
                    >
                        <div className="flex justify-between items-start mb-3">
                            <h4 className="text-md font-bold text-gray-200 group-hover:text-blue-300 transition-colors">
                                {paradigm.name}
                            </h4>
